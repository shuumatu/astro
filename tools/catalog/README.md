...
The catalog is generated from official Hipparcos/VizieR and Gaia TAP queries plus
constellation geometry pinned to one D3-Celestial commit. Upstream responses are cached
...
The script validates input columns, stable identifiers, coordinate ranges, constellation
count, output size, and the SHA-256 checksum of the compressed artifact.
